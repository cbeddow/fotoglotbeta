...
function takeSnapshot() {
  ...
  getCanvasBlob(canvas).then(async function (blob) {
    ...
    console.log(blob);
    image.style = "position: relative; height: auto; top: 20%; width:100%; display: block; !important"
    $('#vid_container').prepend(image);
    const outputClass = await classifyCC(image);
